...
public boolean placeInExistingPortal(Entity par1Entity, double par2, double par4, double par6, float par8)
{
         ...
         else
         {
                 for (k1 = l - short1; k1 <= l + short1; ++k1)
                 {
                         ...
                         for (int l1 = i1 - short1; l1 <= i1 + short1; ++l1)
                         {
                                 ...
                                 {
                                         /** change this block **/
                                         if (this.worldServerInstance.getBlockId(k1, i2, l1) == miningworld.blockid)
                                         {
                                                 /** change this block **/
                                                 while (this.worldServerInstance.getBlockId(k1, i2 - 1, l1) == miningworld.blockid)
                                                 {
                                                         --i2;
                                                 }
         ...
         if (d3 >= 0.0D)
         {
                 ...
                 int j2 = -1;
                 /** change this block **/
                 if (this.worldServerInstance.getBlockId(i - 1, j, k) == miningworld.blockid)
                 {
                         j2 = 2;
                 }
                 /** change this block **/
                 ...
                 /** change this block **/
                 if (this.worldServerInstance.getBlockId(i, j, k - 1) == miningworld.blockid)
                 {
                         j2 = 3;
                 }
                 /** change this block **/
         ...
         for (k2 = 0; k2 < 4; ++k2)
         {
                 for (i3 = 0; i3 < 4; ++i3)
                 {
                         for (l2 = -1; l2 < 4; ++l2)
                         {
                                 ...
                                 /** change these blocks **/
                                 this.worldServerInstance.setBlock(k3, j3, i4, flag ? miningworld.blockid2 : miningworld.blockid, 0, 2);
                         }
                 }
                 for (i3 = 0; i3 < 4; ++i3)
                 {
