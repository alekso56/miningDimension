	...
	public void processCommand(ICommandSender icommandsender, String[] astring) {
		...
		if (astring.length < 2 && playermp != null) {
			throw new WrongUsageException(
					"Playername <letter o for overworld or something else for miningworld>",
					new Object[0]);
		}
		if (playermp.dimension != config.dimension
				&& !astring[1].equalsIgnoreCase("o")) {
			MinecraftServer
					.getServer()
